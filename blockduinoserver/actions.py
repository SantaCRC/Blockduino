# -*- coding: utf-8 -*-
"""Collection of actions to the blockduinoserver for relieved HTTP requests.
...
from blockduinoserver.compilersettings import ServerCompilerSettings
from blockduinoserver import sketchcreator
