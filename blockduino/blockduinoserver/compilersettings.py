...
the the Blockduino and Arduino IDE settings into a file.
...
import blockduinoserver.serialport


class ServerCompilerSettings(object):
    """Singleton class to store and save the Blockduino settings.
    ...
    def set_sketch_name_default(self):
        self.__sketch_name = 'BlockduinoSketch'
    ...
    def populate_serial_port_list(self):
        ...
        port_list = blockduinoserver.serialport.get_port_list()
        self.__serial_ports = {}
        if port_list:
            port_id = 0
    ...
    def save_settings(self):
        ...
        # Blockduino section
        settings_parser.add_section('Blockduino')
        settings_parser.set(
            'Blockduino', 'ide_load', '%s' % self.load_ide_option)
    ...
    def get_settings_file_data(self):
        ...
        try:
            ...
            settings_dict['ide_load'] =\
                settings_parser.get('Blockduino', 'ide_load')
